...
Là một thời gian chạy JavaScript hướng sự kiện không đồng bộ, Node.js được thiết kế để xây dựng
các ứng dụng mạng có thể mở rộng. Trong ví dụ "hello world" sau đây, nhiều
kết nối có thể được xử lý đồng thời. Sau mỗi kết nối, cuộc gọi lại là
